...
def game_loop() -> None:
    ...
    letters = 0  # what letter is player up to in their guess
    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_RETURN and not game_over and letters < 5:
                    ...
                    guess_str = game.list_to_string(game.get_player_attempts()[game.get_no_guesses()])
        ...
        if game.get_no_guesses() == 6:
            ...
            for row in range(0, 6):
                guess_str = game.list_to_string(game.get_player_attempts()[row])
